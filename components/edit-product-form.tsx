...
export function EditProductForm({ product, onEditProduct, categories }: EditProductFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    image: product.image || "",
    metadata: {
      fournisseur: product.metadata?.fournisseur || "",
      reference: product.metadata?.reference || "",
      description: product.metadata?.description || "",
      emplacement: product.metadata?.emplacement || "",
    },
  })
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Modifiez les informations du produit "{product.nom}".</DialogDescription>
        </DialogHeader>
